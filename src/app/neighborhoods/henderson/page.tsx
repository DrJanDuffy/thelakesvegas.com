...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's family-friendly communities. Median price $485K. Call (702) 500-1942.",
  keywords: [
...
const hendersonNeighborhoodFaqs = [
  {
...
const hendersonPageSchemas = combineSchemas(
  generateBreadcrumbSchema([
    { name: "Home", url: "/" },
  ...
  generateNeighborhoodSchema({
    ...
    slug: "henderson",
    description:
      "Nevada's second-largest city known for safety, schools, and family-friendly communities",
    latitude: 36.0395,
    longitude: -114.9817,
    containedIn: "Henderson",
  }),
  generateFAQSchema(hendersonNeighborhoodFaqs)
);

export default function HendersonPage() {
  return (
    <>
      <SchemaScript id="neighborhood-henderson-schema" schema={hendersonPageSchemas} />
      <Navbar />
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <LocalServiceAreaBlurb topic="Henderson home search and listing strategy" />
          </div>
          ...
          <FAQSection
            ...
            subtitle="Safety, neighborhoods, and working with Dr. Jan Duffy"
            faqs={hendersonNeighborhoodFaqs}
          />
