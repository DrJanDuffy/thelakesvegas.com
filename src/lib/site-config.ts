...
export const siteConfig = {
  ...
  tagline: "Homes for sale in The Lakes, Las Vegas",
  brandLine:
    "Berkshire Hathaway HomeServices Nevada Properties | The Lakes, Las Vegas",
...
/** Referrers from our own domains (and local/preview) are not tagged as external. */
export function isOwnedSiteHostname(hostname: string): boolean {
  return (
    hostname.includes("heyberkshire.com") ||
    hostname.includes("thelakesvegas.com") ||
    hostname === "localhost" ||
...
export const localSeo = {
  /** Update when The Lakes GBP review short link is available */
